...
%>
	...
	<div class="header">
        ...
        <ul>
        	<li><a href="#" class="home" onclick="goMenu('index.posco');">홈</a></li>
            <li><a href="#" class="detail" onclick="goMenu('detail.posco');">상세조회</a></li>
            <li><a href="#" class="report" onclick="goMenu('report.posco');">보고서</a></li>
        </ul>
        <p class="user">
        	<span>홍길동 님</span>
