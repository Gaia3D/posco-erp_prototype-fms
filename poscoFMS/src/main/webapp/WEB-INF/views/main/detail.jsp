    ...
    <div class="contents">
        ...
        <div class="view">
            ...
            <div id="survey" class="measure_wrap">
                ...
                <div class="straight">
                    <h4>진직도</h4>
                    <a href="#" title="시계열조회" id="horizontalDeformationAtLast" class="first" onclick="showGraph();">
                    	<span>-10</span>
                    	<input type="hidden" name="" value="" />
                    </a>
                    <a href="#" title="시계열조회" id="horizontalDeformationAtMid" class="middle warn">
                    	<span>-0</span>
                    	<input type="hidden" name="" value="" />
                    </a>
                    <a href="#" title="시계열조회" id="horizontalDeformationAtStart" class="last">
                    	<span>23</span>
                    	<input type="hidden" name="" value="" />
                    </a>
